...
AUTOENCODER_PATH = "/workspace/models/autoencoder.hdf5"
...
history = lstm_model.fit(
    ...
    epochs=epochs,
    verbose=1,
    callbacks=[ModelCheckpoint(filepath='/workspace/models/lstm.hdf5', save_best_only=True, monitor='loss', mode='min', verbose=1),
